...
import { SubscriptionRequest, SubscriptionResponse } from "@/src/api-functions/subscription.api";
...
export const useSubscriptionMutation = (
  options?: UseMutationOptions<SubscriptionResponse, IErrorResponse, SubscriptionRequest>
) => {
